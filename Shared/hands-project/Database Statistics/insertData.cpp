...
void insertDataPoint(PGconn *conn, string major, char gender, int age, char dom_hand, double score_rvlh, double score_right_rvlh, double score_left_rvlh, double score_lvrh, double score_right_lvrh, double score_left_lvrh, double score, double score_right, double score_left)
{
  ...
  string cmd = "INSERT INTO data_summary (major, gender, dominant_hand, age, score_rvlh, score_right_rvlh, score_left_rvlh, score_LVRH, score_right_LVRH, score_left_LVRH, score_total, score_right_total, score_left_total) VALUES ('";
  ...
  cmd = cmd + ss_age + "," + ss_score_rvlh + "," + ss_score_right_rvlh  + "," + ss_score_left_rvlh  + "," + ss_score_lvrh + "," + ss_score_right_lvrh + "," + ss_score_left_lvrh + "," + ss_score + "," + ss_score_right + "," + ss_score_left + ");";
