...
void MainWindow::realtimeDataSlot(double val)
{
...
//        ui->customPlot->graph(4)->addData(0, range_y);  // Just the y-axis
        ...
        ui->customPlot->graph(0)->addData(key_x, val);

        // set data of dots:
        ui->customPlot->graph(1)->clearData();
        ui->customPlot->graph(1)->addData(key_x, val);

//        ui->customPlot->graph(2)->addData(value_y, key_y);

//        ui->customPlot->graph(3)->clearData();
//        ui->customPlot->graph(3)->addData(value_y, key_y);

//        //Ideal Movement of Hands

//        ui->customPlot->graph(5)->addData(range_x/2, value_x);

//        // set data of dots:
//        ui->customPlot->graph(6)->clearData();
//        ui->customPlot->graph(6)->addData(range_x/2, value_x);
