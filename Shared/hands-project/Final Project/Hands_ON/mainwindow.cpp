...
//        //cout<<"2"<<endl;
        ...
        if ((readingRight.GetErrorMessage() == "") && (readingLeft.GetErrorMessage() == "")) {
            ...
            if (trialNumber == 1) {
                ...
                //cout<<"12"<<endl;
                pingRight = readerRightPing.GetPingDistance();

                //cout<<"13"<<endl;
                pingLeft = readerLeftPing.GetPingDistance();
            }
            else {

                //cout<<"14"<<endl;
                pingRight = readerLeftPing.GetPingDistance();

                //cout<<"15"<<endl;
                pingLeft = readerRightPing.GetPingDistance();
            ...
            //cout<<"26"<<endl;
            temp_score_right = scorePercentageVertical(angleRight,tempRight,real_velocity_right,0.04)*10;
            ...
            //cout<<"28"<<endl;
            temp_score_left = scorePercentageVertical(angleLeft,tempLeft,real_velocity_left,0.04)*10;
...
void MainWindow::setupPing(QCustomPlot *pingPlot)
{
    ...
    pingPlot->graph(0)->setScatterStyle(QCPScatterStyle::ssDisc);
...
void MainWindow::on_buttonBox_accepted()
{
    ...
    if (msg.isEmpty()) {
        ...
        readerRightPing.SetTrialNumber(1);
        readerLeftPing.SetTrialNumber(1);
...
void MainWindow::end_of_trial()
{
    ...
    if (!inserted && msgBox.exec()) {
        ...
        if (trialNumber < 3) {
            ...
            readerRightPing.SetTrialNumber(2);
            readerLeftPing.SetTrialNumber(2);
