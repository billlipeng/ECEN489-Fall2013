...
double calculateCoefficientB(double x1, double x2, double x3, double r1, double r2, double r3, double c)
{
  double x1 = log(r1);
  double x2 = log(r2);
  double x3 = log(r3);
...
double calculateCoefficientC(double x1, double x2, double x3, double r1, double r2, double r3, double b, double c)
{
  double x1 = log(r1);
  double x2 = log(r2);
  double x3 = log(r3);
